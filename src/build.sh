...
i386-elf-gcc -nostdlib -nostdinc++ -nostdinc -ffreestanding -m32 -fno-pic -fno-pie -fno-rtti -fno-exceptions -fno-threadsafe-statics -masm=intel -c -I../include vbe.cpp
...
ld -m elf_i386 -T ../link.ld -o boot.bin arith64.o int386.o minlib.o printf.o test.o vbe.o
